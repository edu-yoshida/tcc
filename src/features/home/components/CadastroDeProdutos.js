...
const CadastroDeProdutos = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    let categoriaFinal;
    if (formState.categoria === 'outro') {
      categoriaFinal = formState.outraCategoria;
    } else {
      categoriaFinal = formState.categoria;
    }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="pescados">Frutos do Mar</option>
                        <option value="outro">Outro</option>
                      </select>
                      {formState.categoria === 'outro' && (
                        <div className="mt-2">
                          <label htmlFor="outraCategoria" className="block text-sm font-medium text-gray-700 mb-1">
                            Qual categoria?
                          </label>
                          <input
                            type="text"
                            name="outraCategoria"
                            value={formState.outraCategoria}
                            onChange={handleChange}
                            placeholder="Ex: Alimentos Funcionais"
                            className="block w-full rounded-lg border border-gray-300 shadow-sm focus:ring-2 focus:ring-orange-400 focus:border-orange-400 p-2 text-sm"
                          />
                        </div>
                      )}
