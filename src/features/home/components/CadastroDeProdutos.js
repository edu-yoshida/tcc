  ...
  return (
    ...
    <div className="flex w-screen h-screen overflow-hidden bg-[#ffffff] text-gray-800 font-sans">
      ...
      <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
        {/* Topbar */}
        <div className="h-28 shrink-0 bg-gradient-to-r from-orange-400 via-yellow-500 to-orange-600 flex flex-col items-center justify-center text-white shadow-md rounded-b-3xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 w-full">
                ...
                <div>
                  ...
                  <label
                    ...
                    className="cursor-pointer flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg h-32 bg-gray-50 hover:bg-gray-100 transition"
                  >
                    {formState.imagem ? (
                      <img
